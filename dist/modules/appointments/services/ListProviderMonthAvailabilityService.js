...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const numberOfDaysInMonth = (0, _dateFns.getDaysInMonth)(new Date(year, month - 1)); // para cada dia do mês vou criar um array com a seguinte estrutura

    const eachDayArray = Array.from({
      length: numberOfDaysInMonth
    }, (_, index) => index + 1); // verifica se tem agendamento nesse dia especifico
